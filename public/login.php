                    ...
                    <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" method="POST">
                                ...
                                <button type="submit" class="w-full text-white bg-purple-500 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Se connecter</button>
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Je n'ai pas encore de compte? <a href="inscription.php" class="font-medium text-stone-700 hover:underline hover:text-purple-500 dark:text-primary-500">S'inscrire</a>
                                </p>
                            </form>
                        </div>
                    </div>
